...
Download the code file and save the file game.py
Open the file in Terminal or Any IDEs like VScode Instruction For Testing ● When the game starts,there are three options-stone,paper or scissors. ● Choose exactly one option. ● The computer will randomly choose the option and give the result
